                ...
                <div class="login-content">
                    <form id="loginForm" data-parsley-validate="">
                        ...
                        <div class="form-group m-b-15">
                            <input type="text" name="username" class="form-control form-control-lg" placeholder="Username" required style="text-transform:lowercase" />
                        </div>
                        <div class="form-group m-b-15">
                            <input type="password" name="password" class="form-control form-control-lg" placeholder="Password" required />
                        </div>
                        <div class="login-buttons">
                            <button type="submit" id="signMe" class="btn btn-success btn-block btn-lg validate" >Sign me in</button>
                        </div>
                        <div class="m-t-10 m-b-10 p-b-10 text-inverse">
                            Don't remember your password ? Click <a href="index.php?url=login/forgot" class="text-success">Here</a>
                        </div>
